...
var _saveAs = (function(view) {
	...
	var
		...
		, click = function(node) {
			...
			event = new MouseEvent("click", {ctrlKey: false}); 
...
var _exportData = function ( dt, config )
{
	...
	var sqlheader = config.sqlheader ? 'INSERT INTO MyTable ('+join( data.header )+') VALUES'+newLine : '';
...
if(i==lastnum){
	endchar = ';';
		...
		body.push( '('+join( data.body[i] )+')'+endchar+'' );
}else{
...
if(sqlheader){
	return {
		str: sqlheader + body.join( newLine ) + footer,
		rows: body.length
	};
}else{
	return {
...
// TXT export
//
DataTable.ext.buttons.txtHtml5 = {
	className: 'buttons-txt buttons-html5',
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons.txt', 'TXT' );
	},
...
// SQL export
//
DataTable.ext.buttons.sqlHtml5 = {
	className: 'buttons-sql buttons-html5',
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons.sql', 'SQL' );
	},
...
// XML (xml) export
//
DataTable.ext.buttons.xmlHtml5 = {
	className: 'buttons-xml buttons-html5',
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons.xml', 'XML' );
	},
...
// XML - Pre-defined strings to build a minimal xml file
var output = 
