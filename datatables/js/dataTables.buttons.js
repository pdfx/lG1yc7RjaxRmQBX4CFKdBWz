 ...
 */
Buttons.defaults = {
	buttons: [ 'copy', 'excel', 'csv', 'json', 'pdf', 'print' ],
	name: 'main',
	tabIndex: 0,
	dom: {
		container: {
...
$.extend( _dtButtons, {
	...
	txt: function ( dt, conf ) {
		if ( _dtButtons.txtHtml5 && _dtButtons.txtHtml5.available( dt, conf ) ) {
			return 'txtHtml5';
		}
	},
	sql: function ( dt, conf ) {
		if ( _dtButtons.sqlHtml5 && _dtButtons.sqlHtml5.available( dt, conf ) ) {
			return 'sqlHtml5';
		}
	},
	xml: function ( dt, conf ) {
		if ( _dtButtons.xmlHtml5 && _dtButtons.xmlHtml5.available( dt, conf ) ) {
			return 'xmlHtml5';
		}
	},
